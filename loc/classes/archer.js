export default {
  ...
  description: {
    ...
    nl: 'Boogschutters doen hoge schade aan een enkel doel of explosieve schade op meerdere tegenstanders. Een goede boogschutter zal altijd zijn afstand bewaren en vijanden vanuit de verte beschieten.',
